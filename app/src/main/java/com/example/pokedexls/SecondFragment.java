...
public class SecondFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bWriteName = bWriteName.findViewById(R.id.bWriteName);
        tTrainerName = tTrainerName.findViewById(R.id.tTrainerName);

        tTrainerName.setText(trainer.getName());
        bWriteName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(requireActivity(), TrainerName.class);
